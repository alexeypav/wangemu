...
#include "../../shared/terminal/TerminalState.h"      // state needed to create crt image
#include "../system/Ui.h"                 // emulator interface
#include "UiCrt.h"              // this module's defines
#include "../dialogs/UiCrtErrorDlg.h"      // error code decoder
#include "../frames/UiCrtFrame.h"         // this module's owner
#include "../system/UiSystem.h"           // sharing info between Ui* wxgui modules
